...
***Collapses the variables into bins with averages 
binscatter earnings yrs_schooling, controls(ability) name(b_2, replace)
***Can account for controls in the command
